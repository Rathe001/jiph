...
(function () {
    ...
    modCommon.controller('ctrlMain', ['$window', 'User', 'Facebook', 'Accounts', function ($window, User, Facebook, Accounts) {
        var vm = this;
...
angular.module('modCommon').factory('Accounts', ['Facebook', function (Facebook) {
    var service = {};
