...
modAdSets.controller('ctrlAdSets', ['$scope', '$routeParams', 'AdSets', 'Accounts', 'Dictionary', 'Currency', 'DateIntervals', function ($scope, $routeParams, AdSets, Accounts, Dictionary, Currency, DateIntervals) {
    var vm = this;
...
modAds.controller('ctrlAds', ['$scope', '$routeParams', 'Ads', 'Accounts', 'Currency', 'Dictionary', 'DateIntervals', function ($scope, $routeParams, Ads, Accounts, Currency, Dictionary, DateIntervals) {
    var vm = this;
    var campaignId = $routeParams.campaignId;
