...
modAudiences.directive('audience', ['Facebook', function (Facebook) {
    return {
        restrict: 'EA',
        scope: {},
        bindToController: {
    ...
    function controller($scope) {
        ...
        $scope.$watch(function () {
            ...
            if (newVal && JSON.stringify(newVal) !== "{}") _addLocation();
        });
        ...
        $scope.$watch(function () {
            ...
            if (newVal && JSON.stringify(newVal) !== "{}") _addLocale();
        });
        ...
        function removeLocale(l) {
            var index = vm.audience.targeting.locales.indexOf(l);
