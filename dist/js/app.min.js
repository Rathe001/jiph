...
angular.module('modAds').factory('Ads', ['$q', 'Loading', function ($q, Loading) {
    var service = {};
...
angular.module('modAdSets').factory('AdSets', ['$q', 'Loading', function ($q, Loading) {
    var service = {};
...
angular.module('modCampaigns').factory('Campaigns', ['$q', 'Loading', function ($q, Loading) {
    var service = {};
...
modAds.controller('ctrlAds', ['$scope', 'Ads', 'Accounts', function ($scope, Ads, Accounts) {
    var vm = this;
...
modAdSets.controller('ctrlAdSets', ['$scope', 'AdSets', 'Accounts', function ($scope, AdSets, Accounts) {
    var vm = this;
...
modCampaigns.controller('ctrlCampaigns', ['$scope', 'Campaigns', 'Accounts', function ($scope, Campaigns, Accounts) {
    var vm = this;
...
angular.module('modCommon').factory('Accounts', ['$window', 'Facebook', function ($window, Facebook) {
    ...
    function getAll() {
        return Facebook.get('/me/adaccounts', { fields: 'name,id,owner_business' }).then(function (results) {
