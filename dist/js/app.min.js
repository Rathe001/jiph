...
(function () {
    var app = angular.module('app', ['modTemplates', 'modAutomation', 'modCampaigns', 'modCommon', 'modDashboard', 'modHelp', 'modPresetAdGroups', 'modPresetAudiences', 'modTracking']);
...
(function () {
    ...
    modCommon.controller('ctrlMain', ['$scope', '$location', '$window', 'User', 'Facebook', 'Accounts', 'Navigation', 'Loading', function ($scope, $location, $window, User, Facebook, Accounts, Navigation, Loading) {
        var vm = this;
...
(function () {
    ...
    modCampaigns.controller('ctrlCampaigns', [function () {}]);
})();
'use strict';
...
(function () {
    ...
    modDashboard.controller('ctrlDashboard', ['$timeout', 'Dashboard', 'EstimateTimeToCompletion', 'Accounts', 'Loading', function ($timeout, Dashboard, EstimateTimeToCompletion, Accounts, Loading) {
        var vm = this;
        ...
        function _getAccountInsights(accountId) {
            ...
            Dashboard.generateReport(accountId, vm.startDate, vm.endDate).then(function (report) {
                ...
                Dashboard.fetchAsyncReport(asyncReportId).then(function (report) {
                    if (report && report.summary && report.summary.account_id) {
                        Object.assign(vm.accounts.find(function (account) {
                            return account.id === "act_" + report.summary.account_id;
