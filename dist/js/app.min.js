...
var modAudiences = angular.module('modAudiences', ['modCommon']);
...
angular.module('modAdGroups').factory('AdGroups', ['$q', '$window', 'Loading', function ($q, $window, Loading) {
    var service = {};
    ...
    function getAll(facebookAdAccountId) {
        var deferred = $q.defer();
        var url = "/api/prototype/adGroups";
...
angular.module('modAudiences').factory('Audiences', ['$q', '$window', 'Loading', function ($q, $window, Loading) {
    var service = {};
