...
(function () {
    ...
    modCommon.controller('ctrlMain', ['$scope', '$location', '$window', 'User', 'Facebook', 'Accounts', 'Navigation', function ($scope, $location, $window, User, Facebook, Accounts, Navigation) {
        var vm = this;
...
(function () {
    ...
    modDashboard.controller('ctrlDashboard', ['Dashboard', function (Dashboard) {
        Dashboard.getInsights('act_845503345516804', '1970-01-01', '2015-11-01').then(function (response) {
